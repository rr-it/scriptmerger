...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['t3lib/class.t3lib_tcemain.php']['clearCachePostProc'][] =
	'EXT:scriptmerger/Classes/CacheHook.php:ScriptmergerCacheHook->clearCachePostProc';
...
if (TYPO3_MODE == 'FE') {
	$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-output'][] =
		'EXT:scriptmerger/Classes/OutputHook.php:ScriptmergerOutputHook->contentPostProcOutput';
	$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-all'][] =
		'EXT:scriptmerger/Classes/OutputHook.php:ScriptmergerOutputHook->contentPostProcAll';
}
